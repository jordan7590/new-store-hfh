...
const TermsOfUse = () => {
  return (
    <>
      <CommonLayout parent="home" title="Terms and Conditions of Use">
        <div>
     
         <div className="bg-img main-img subpage"
                   style={{
                    backgroundImage: 'url(/assets/images/icon/privacy-header.jpg)',
                    backgroundPositionY: '68%'
                }}>
                <Container>
                    <div className="main-title text-bottom">
                        <h1 className="text-gray title-text">Terms and Conditions of Use</h1>
                    </div>
                </Container>
              </div>
        </div>
            ...
            <Row>
              <Col lg="12">
                <div className="policy-body">
                  <p><strong>Last Modified: April 1, 2024</strong></p>
                  <ul>
                          <li>
                              ...
                              <ul>
                                  <li>
                                      <p>Welcome to medicallogowear.com (the 'Site'), a web site operated on behalf of Hoyt & Company, LLC. The Terms and Conditions of Use include any posted guidelines
                                          ...
                                          the Site or by clicking to accept or agree to the Terms and Conditions when this option
                                          is made available to you, you: (i) acknowledge that you have reviewed and agree to be
                                          bound by the Terms and Conditions; (ii) represent and warrant that you are at least
                                          eighteen (18) years old and reside in the United States; and (iii) represent and warrant
                                          that you have the legal authority to accept the Terms and Conditions. If you do not meet
                                          all of these requirements, you mustch not access or use the Site. If you work for or
                                          represent a business, you represent and agree that you are authorized by that business
                                          to enter into and be bound by the Terms and Conditions on behalf of that business. This
                                          is a legally binding agreement. If you do not agree with the Terms and Conditions, you
                                          are not authorized to use the Site.</p>
                                  </li>
                              </ul>
                          </li>
                          <li>
                              <p> <strong><u>ACCESS TO THE SITE</u></strong> </p>
                              <ul>
                                  <li>
                                      <p>Access to certain portions of this Site may require login and password information
                          ...
                          <li>
                              <p> <strong><u>CONTENT AND SERVICES</u></strong> </p>
                              <ul>
                                  <li>
                          ...
                          <li>
                              <p> <strong><u>USE OF THE SITE AND REGISTRATION</u></strong> </p>
                              <ul>
                                  <li>
                                      <p>Use of the Site is voluntary. You may choose not to use the Site and you may choose not
                                          ...
                                          if, in our opinion, you have violated any provision of these Terms and Conditions.</p>
                                  </li>
                              </ul>
                          </li>
                          <li>
                          ...
                          <li>
                              <p> <strong><u>PROHIBITED BEHAVIOR</u></strong> </p>
                              <ul>
                                  <li>
                                      <p>You are responsible for all Content that you upload, post, email or otherwise transmit
                                          ...
                                          offer any portion of the Site to any third party. You shall not use the Site or Services
                                          to:</p>
                                  </li>
                                  <ul>
                                      <li>
                                          <p>Upload, post, email, or otherwise transmit any Content that infringes any patent,
                                              trademark, trade secret, copyright or other intellectual property right, privacy
                                              right, or publicity right of any person or entity. By uploading, posting, emailing
                                              or otherwise transmitting any Content, you represent and warrant that you have all
                                              rights to take such action with respect to the Content;</p>
                                      </li>
                                      <li>
                                          <p>Upload, post, email, or otherwise transmit any Content that is illegal, harmful,
                                              threatening, abusive, harassing, tortious, defamatory, vulgar, obscene, libelous,
                                              pornographic, sexually explicit, invasive of another's privacy, hateful or racially,
                                              ethnically, or otherwise offensive;</p>
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                          <p>Use the Site or Services for any purpose or in any manner that violates any local,
                                              state or federal law or regulation or the law or regulation of any foreign
                                              government;</p>
                                      </li>
                                      <li>
                                      ...
                                      <li>
                                          <p>Upload, post, email or otherwise transmit without authorization any material that
                                              contains personal or private information concerning any third party person or entity
                                              (except for a business you are authorized to act on behalf of), including without
                                              limitation, phone number(s) or addresses, credit/debit cards, calling cards, account
                                              numbers, social security numbers, passwords or other similar information.</p>
                                      </li>
                                  </ul>
                                  <li>
                                  ...
                                  <ul>
                                      <li>Use the Site in any manner that could disable, overburden, damage, or impair the site or
                                          interfere with any other party's use of the Site, including their ability to engage in
                                          real time activities through the Site;</li>
                                      <li>Use any robot, spider, or other automatic device, process, or means to access the Site
                                          for any purpose, including monitoring or copying any of the material on the Site;</li>
                                      <li>Use any manual process to monitor or copy any of the material on the Site, or for any
                                          other purpose not expressly authorized in these Terms and Conditions, without our prior
                                          written consent;</li>
                                      <li>Use any device, software, or routine that interferes with the proper working of the
                                          Site;</li>
                                      <li>Introduce any viruses, Trojan horses, worms, logic bombs, or other material that is
                              ...
                              <ul>
                                  <li>
                                      <p>You understand that we cannot and do not guarantee or warrant that files available for
                                          ...
                                          WITH RESPECT TO ANY DEFECT IN OR DISSATISFACTION WITH THE SITE, CONTENT OR SERVICES IS
                                          TO CEASE TO USE THE SITE OR SERVICES. YOU MAY HAVE OTHER RIGHTS WHICH MAY VARY FROM
                                          STATE TO STATE OR WITHIN NATIONAL JURISDICTIONS.</p>
                                  </li>
                              </ul>
                          </li>
                          <li>
                          ...
                          <li>
                              ...
                              <ul>
                                  <li>
                                      ...
                                      <ul>
                                          <li>
                                              <p>This Site and its entire Contents, features, and functionality (including but not
                                                  ...
                                                  intellectual property or proprietary rights laws. Certain materials are used by
                                          ...
                                          <li>
                                              <p>If you print, copy, modify, download, or otherwise use or provide any other
                                                  person with access to any part of the Site in breach of the Terms and
                          ...
                          <li>
                              ...
                              <ul>
                                  <li>
                                      <p>The Site may contain message boards, chat rooms, personal web pages or profiles, forums,
                                          bulletin boards, and other interactive features (collectively, "Interactive Services")
                                          that allow users to post, submit, publish, display, or transmit to other users or other
                                          persons (hereinafter, "post") content or materials (collectively, "User Contributions")
                                          on or through the Site.</p>
                                  </li>
                                  <li>
                                      <p>All User Contributions must comply with the Content Standards set out in these Terms and
                                          Conditions.</p>
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                      ...
                                      <p>You own or control all rights in and to the User Contributions and have the right to
                                          grant the license granted above to us and our respective licensees, successors, and
                                          assigns.</p>
                                      <p>All of your User Contributions do and will comply with these Terms and Conditions.</p>
                                  </li>
                                  <li>
                                  ...
                                  <li>
                                      <p>We are not responsible or liable to any third party for the content or accuracy of any
                                          User Contributions posted by you or any other user of the Site.</p>
                                  </li>
                              </ul>
                          </li>
                          <li>
                          ...
                          <li>
                              ...
                              <ul>
                                  <li>
                                      <p>The owner of the Site is based in the United States. We provide this Site for use only by
                                          persons located in the United States. We make no claims that the Site or any of its
                              ...
                              <ul>
                                  <li>
                                      <p>You agree to defend, indemnify, and hold Hoyt & Company, its officers, directors, employees, agents,
                                          ...
                                          Terms and Conditions or from your use or misuse of this Site.</p>
                                  </li>
                              </ul>
                          </li>
                          <li>
                              ...
                              <ul>
                                  <li>
                                      <p>The Terms and Conditions constitute the entire agreement between you and Hoyt & Company relating to
                                          ...
                                          cause of action arose. The section titles of the Terms and Conditions are merely for
                                          convenience and will not have any effect on the substantive meaning of this Agreement.
                                      </p>
                                  </li>
                                  <li>
                                      <p>YOUR USE OF THE SITE INDICATES THAT YOU AGREE TO THE FOREGOING TERMS AND CONDITIONS. IF
                                          YOU DO NOT AGREE TO THE TERMS AND CONDITIONS, DO NOT USE THE SITE.</p>
                                  </li>
                              </ul>
                          </li>
                       </ul>
