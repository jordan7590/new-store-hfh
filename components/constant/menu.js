export const MENUITEMS = [
   ...
   {
       path: '/shop/left_sidebar', title: 'Brands', type: 'link'   
   },
   {
       path: '/shop/left_sidebar', title: 'Apparel', type: 'link'   
   },
   {
       path: '/shop/left_sidebar', title: 'Promotional Items', type: 'link'   
   },
   {
       path: '/shop/left_sidebar', title: 'Drinkwear', type: 'link'   
   },
   {
       path: '/shop/left_sidebar', title: 'Bags', type: 'link'   
   },
   {
       path: '/shop/left_sidebar', title: 'Department or Color', type: 'link'   
   }
